...
public class BoardTestSuite {
    ...
    public void testAddTaskListAverageWorkingOnTask(){
        ...
        List<TaskList> inProgressTasks = new ArrayList<>();
        inProgressTasks.add(new TaskList("In progress"));
        double tasks=project.getTaskLists().stream().filter(inProgressTasks::contains)
                .flatMap(t->t.getTasks().stream()).count();
        double daysFrom=project.getTaskLists().stream()
                . filter(inProgressTasks::contains)
                .flatMap(tl -> tl.getTasks().stream())
        ...
        //Then
        Assert.assertEquals(10,daysFrom/tasks,0.1);
    }
    @Test
    public void testAddTaskListAverageWorkingOnTask1(){
        ...
        //Then
        Assert.assertEquals(10,avrDaysFrom,0.1);
    }
